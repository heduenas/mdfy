...
python3 mdfy.py ch01.tex 1/statements/en.md
python3 mdfy.py ch02.tex 2/statements/en.md
python3 mdfy.py ch03.tex 3/statements/en.md
python3 mdfy.py ch04.tex 4/statements/en.md
python3 mdfy.py ch05.tex 5/statements/en.md
python3 mdfy.py ch06.tex 6/statements/en.md
python3 mdfy.py ch07.tex 7/statements/en.md
python3 mdfy.py ch08.tex 8/statements/en.md
